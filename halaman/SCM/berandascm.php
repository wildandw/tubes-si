      ...
      <table class="product-table">
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($hasil)) {
            ...
            echo "<tr>
                  <form action='aksitambahscm.php' method='POST'>
                  <td>$n</td>
                  <td>$kode_produk</td>
                  <td>$nama_produk</td>
                  <td><input type='text' id='qty' name='qty' value='$qty'></td>
                  ...
                  <td>$alamat</td>
                  <td>$tgl_pengajuan</td>
                  <td><select id='statuspengajuan' name='statuspengajuan'>
                  <option value='Disetujui' " . ($statuspengajuan == 'Disetujui' ? 'selected' : '') . ">Disetujui</option>
                  <option value='Tidak disetujui' " . ($statuspengajuan == 'Tidak disetujui' ? 'selected' : '') . ">Tidak disetujui</option>
                  <option value='Sedang diproses' " . ($statuspengajuan == 'Sedang diproses' ? 'selected' : '') . ">Sedang diproses</option>
                </select></td>
